...
static GLboolean rgb_use(XM_GLES2_Renderer *renderer)
{
...
static GLsizei rgb565_getBufferWidth(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!overlay)
        return 0;
...
static GLboolean rgb565_uploadTexture(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!renderer || !overlay)
        return GL_FALSE;
...
XM_GLES2_Renderer *XM_GLES2_Renderer_create_rgb565(SDL_VoutOverlay *overlay)
{
    ...
    const char *fsh = XM_GLES2_getFragmentShader_rgb();
...
static GLsizei rgb888_getBufferWidth(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!overlay)
        return 0;
...
static GLboolean rgb888_uploadTexture(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!renderer || !overlay)
        return GL_FALSE;
...
static GLsizei rgbx8888_getBufferWidth(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!overlay)
        return 0;
...
static GLboolean rgbx8888_uploadTexture(XM_GLES2_Renderer *renderer, SDL_VoutOverlay *overlay)
{
    if (!renderer || !overlay)
        return GL_FALSE;
