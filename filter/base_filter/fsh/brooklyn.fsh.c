...
* Create Fragment shaders of brooklyn effects
*/

#include "ijksdl/gles2_xm/internal.h"

static const char g_shader_brooklyn[] = XM_GLES_STRING(
        ...
        uniform lowp sampler2D inputImageTexture4;
...
void main()
{
    ...
    // normal blend
    vec4 bg2 = texture2D(inputImageTexture3, vv2_Texcoord);
    bg2.a *= 0.9;
