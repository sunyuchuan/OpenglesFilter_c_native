...
* Create Fragment shaders of sakura effects
*/

#include "ijksdl/gles2_xm/internal.h"

static const char g_shader_sakura[] = XM_GLES_STRING(
...
void main() {
    // naver skin
    lowp vec4 c0 = texture2D(us2_Sampler, vv2_Texcoord);
    lowp vec4 c1 = gaussianBlur(us2_Sampler);
