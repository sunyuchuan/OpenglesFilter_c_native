...
* Create Fragment shaders of amaro effects
*/

#include "ijksdl/gles2_xm/internal.h"

static const char g_shader_amaro[] = XM_GLES_STRING(
        precision highp float;
        varying highp vec2 vv2_Texcoord;
        uniform lowp sampler2D us2_Sampler;

        uniform lowp sampler2D inputImageTexture2; //blowout;
        uniform lowp sampler2D inputImageTexture3; //overlay;
        uniform lowp sampler2D inputImageTexture4; //map
