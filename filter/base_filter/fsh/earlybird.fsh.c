...
* Create Fragment shaders of early-bird effects
*/

#include "ijksdl/gles2_xm/internal.h"

static const char g_shader_earlybird[] = XM_GLES_STRING(
            precision highp float;
            varying highp vec2 vv2_Texcoord;
            uniform lowp sampler2D us2_Sampler;

            uniform lowp sampler2D inputImageTexture2; //earlyBirdCurves
            uniform lowp sampler2D inputImageTexture3; //earlyBirdOverlay
            uniform lowp sampler2D inputImageTexture4; //vig
            uniform lowp sampler2D inputImageTexture5; //earlyBirdBlowout
            uniform lowp sampler2D inputImageTexture6; //earlyBirdMap
